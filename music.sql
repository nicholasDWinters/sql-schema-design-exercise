...
VALUES
  ...
  INSERT INTO details (song_id, artist_id, producer_id) VALUES
  (1, 1, 1), (1, 1, 2), (2, 2,3),(3,3,4),(3,4,4),(4,5,5),
  (4,6,5),(5,7,6),(6,8,7),(6,9,7),(7,10,8),(7,10,9),(7,11,8),
  (7,11,9), (8,12,10),(8,13,10),(8,12,11),(8,13,11),(9,14,12),(10,15,13);
